...
||||||| parent of c9b523d51f (kernel: physical-equality fast paths in conversion's compare_under)
...
=======
  ...
  | CoFix (i1, (_, tl1, bl1)), CoFix (i2, (_, tl2, bl2)) ->
    ...
    && (let n = Array.length tl1 in
        Array.equal_norefl (fun c1 c2 ->
          compare_under (usubs_liftn n e1) c1 (usubs_liftn n e2) c2) bl1 bl2)
>>>>>>> c9b523d51f (kernel: physical-equality fast paths in conversion's compare_under)
